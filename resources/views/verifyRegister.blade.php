...
@section ('content')
    @if(isset($user))
        <div class = "position-absolute top-50 start-50 translate-middle p-3 col-md-9 border">
            <div class="text-center text-uppercase fw-weight-bold">Письмо с подтверждением регистарции отправлено
            ...
            <div class="mt-3 text-center">
                ...
                <a href="/register" class="btn btn-outline-info d-inline">На страницу регистрациии</a>
            </div>
        </div>
    @endif
@endsection
